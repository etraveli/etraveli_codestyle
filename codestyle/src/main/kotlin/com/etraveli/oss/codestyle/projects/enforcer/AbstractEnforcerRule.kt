...
/**
 * Abstract Enforcer rule specification, handling some pretty printing of Maven's Enforcement exceptions.
 *
 * @param enforcerLevel Assigns the EnforcerLevel of this AbstractEnforcerRule.
 *
...
abstract class AbstractEnforcerRule(
   ...
   */
  protected open var cacheable = false
  ...
  override fun execute(helper: EnforcerRuleHelper) {
    ...
    try {
      ...
      var message = ("\n"
        + "\n#"
        + "\n# Structure rule failure (${this::class.java.simpleName}):"
  ...
  override fun toString(): String = "Etraveli Codestyle MavenEnforcerRule: ${this.javaClass.simpleName}"
  ...
  companion object {
     ...
     * @return `true` if any element within source returns true to `toCheck.startsWith(element)`.
     */
    @JvmStatic
